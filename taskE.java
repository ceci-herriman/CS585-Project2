...
rm -rf ~/shared_folder/project2/part2/partA/outputFinal
hdfs dfs -rm -r -f /user/ds503/project2/part2/partE/silhouetteOutput
hadoop jar taskE.jar taskE

View results:
cat ~/shared_folder/project2/part2/partA/outputFinal/part-r-00000
    ...
    public static class taskOutputCentroids extends Mapper<Object, Text, Text, Text> {
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            for (int i = 0; i < numDimensions; i++) {
                ...
                centroidKey.append(vals[i]);
            }

            context.write(new Text(centroidKey.toString()), new Text(context.getConfiguration().get("centroid.convergence")));
        }
    }
    ...
    */
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException, java.net.URISyntaxException {
        ...
        for(int i = 0; i < k; i++) {
            ...
            String outputPath = "/user/ds503/project2/part2/partE/output/output_iteration_" + i;
